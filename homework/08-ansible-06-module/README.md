# Домашняя работа к занятию "08.04 Создание собственных modules"
...
**ОТВЕТ:** Выполнил последовательно пункты с 1 по 16, всё получилось, вот итоговый выхлоп первого и второго запуска playbook`a с ролью:  

```bash
wizard:test123/ $ ansible-playbook site.yml -v
Using /etc/ansible/ansible.cfg as config file
[WARNING]: No inventory was parsed, only implicit localhost is available
[WARNING]: provided hosts list is empty, only localhost is available. Note that the implicit localhost does not match 'all'

PLAY [Playbook test file_create role] ******************************************************************************************************************

TASK [Gathering Facts] *********************************************************************************************************************************
ok: [localhost]

TASK [my_own_namespace.yandex_cloud_elk.file_create : Create file with content] ************************************************************************
changed: [localhost] => {"changed": true, "res_content": "Some text inside file 1231", "res_path": "./my_test_playbook_file111"}
...
TASK [my_own_namespace.yandex_cloud_elk.file_create : Create file with content] ************************************************************************
ok: [localhost] => {"changed": false, "res_content": "Some text inside file 1231", "res_path": "./my_test_playbook_file111"}
